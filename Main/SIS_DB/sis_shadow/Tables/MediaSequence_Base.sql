CREATE TABLE sis_shadow.MediaSequence_Base
...
GO
CREATE NONCLUSTERED COLUMNSTORE INDEX cci_MediaSequence_Base ON [sis_shadow].[MediaSequence_Base](IEPart_ID, MediaSection_ID, IESystemControlNumber)
GO
Create nonclustered index IX_MediaSequence_Base_IE_ID on sis_shadow.MediaSequence_Base (IE_ID)  INCLUDE (MediaSection_ID,Sequence_Number);

GO
CREATE NONCLUSTERED INDEX IX_MediaSequence_Base_IESystemControlNumber ON [sis_shadow].[MediaSequence_Base] ([IESystemControlNumber], [MediaSection_ID], [IEPart_ID])

GO
CREATE NONCLUSTERED INDEX [IX_MediaSequence_Base_MediaSection_ID_IEPart_ID_IESystemControlNumber] ON [sis_shadow].[MediaSequence_Base]
(
    [CCR_Indicator] DESC,
    [MediaSection_ID] ASC,
    [IEPart_ID]
...
ON [sis_shadow].[MediaSequence_Base] ([LastModified_Date])
INCLUDE ([IEPart_ID],[IESystemControlNumber])
GO

CREATE NONCLUSTERED INDEX [IX_MediaSequence_Base_IEPart_ID]
ON [sis_shadow].[MediaSequence_Base] ([IEPart_ID])
INCLUDE ([MediaSection_ID],[IESystemControlNumber])
GO

CREATE NONCLUSTERED INDEX [IX_MediaSequence_Base_MediaSection_ID_IEPart_ID] ON [sis_shadow].[MediaSequence_Base]
(
       [MediaSection_ID] ASC,
	   [IEPart_ID],
