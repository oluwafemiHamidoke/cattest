...
-- Modify Date: 
-- Description: Conditional load from STAGING MASCCRMEDIA
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.MASCCRMEDIA_Merge    
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @FORCE_LOAD = 'FALSE'
        BEGIN
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='MASCCRMEDIA', @SISWEB_OWNER_STAGING_TABLE = 'MASCCRMEDIA'
        END;
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.MASCCRMEDIA;
            
            INSERT INTO SISWEB_OWNER.MASCCRMEDIA (CCRMEDIARID,REPAIRTYPEINDICATOR,SNP,BEGINNINGRANGE,ENDRANGE,LASTMODIFIEDDATE)
            SELECT CCRMEDIARID,REPAIRTYPEINDICATOR,SNP,BEGINNINGRANGE,ENDRANGE,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.MASCCRMEDIA;
        ...
        COMMIT;
        						...
        						UPDATE STATISTICS SISWEB_OWNER.MASCCRMEDIA WITH FULLSCAN;
