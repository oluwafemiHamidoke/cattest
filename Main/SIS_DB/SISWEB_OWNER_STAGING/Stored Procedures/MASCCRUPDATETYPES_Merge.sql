...
-- Modify Date: 
-- Description: Conditional load from STAGING MASCCRUPDATETYPES
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.MASCCRUPDATETYPES_Merge    
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @FORCE_LOAD = 'FALSE'
        BEGIN
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='MASCCRUPDATETYPES', @SISWEB_OWNER_STAGING_TABLE = 'MASCCRUPDATETYPES'
        END;
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.MASCCRUPDATETYPES;
            
            INSERT INTO SISWEB_OWNER.MASCCRUPDATETYPES (UPDATETYPEINDICATOR,LANGUAGEINDICATOR,UPDATETYPEDESCRIPTION,SEQUENCENUMBER,LASTMODIFIEDDATE)
            SELECT UPDATETYPEINDICATOR,LANGUAGEINDICATOR,UPDATETYPEDESCRIPTION,SEQUENCENUMBER,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.MASCCRUPDATETYPES;
        ...
        COMMIT;
        						...
        						UPDATE STATISTICS SISWEB_OWNER.MASCCRUPDATETYPES WITH FULLSCAN;
