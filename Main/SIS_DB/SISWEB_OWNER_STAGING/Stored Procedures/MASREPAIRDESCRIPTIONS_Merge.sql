...
-- Modify Date: 
-- Description: Conditional load from STAGING MASREPAIRDESCRIPTIONS
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.MASREPAIRDESCRIPTIONS_Merge    
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @FORCE_LOAD = 'FALSE'
        BEGIN
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='MASREPAIRDESCRIPTIONS', @SISWEB_OWNER_STAGING_TABLE = 'MASREPAIRDESCRIPTIONS'
        END;
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.MASREPAIRDESCRIPTIONS;
            
            INSERT INTO SISWEB_OWNER.MASREPAIRDESCRIPTIONS (REPAIRCODE,REPAIRTYPE,LANGUAGEINDICATOR,REPAIRDESCRIPTION,LASTMODIFIEDDATE)
            SELECT REPAIRCODE,REPAIRTYPE,LANGUAGEINDICATOR,REPAIRDESCRIPTION,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.MASREPAIRDESCRIPTIONS;
        ...
        COMMIT;
        						...
        						UPDATE STATISTICS SISWEB_OWNER.MASREPAIRDESCRIPTIONS WITH FULLSCAN;
