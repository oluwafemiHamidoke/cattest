...
-- Modify Date: 
-- Description: Merge SISWEB_OWNER_STAGING.LNKCCRUPDATES to SISWEB_OWNER.LNKCCRUPDATES
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.LNKCCRUPDATES_Merge
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='LNKCCRUPDATES', @SISWEB_OWNER_STAGING_TABLE = 'LNKCCRUPDATES'
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.LNKCCRUPDATES;
            
            INSERT INTO SISWEB_OWNER.LNKCCRUPDATES (UPDATERID,OPERATIONRID,UPDATETYPEINDICATOR,IESYSTEMCONTROLNUMBER,LASTMODIFIEDDATE)
            SELECT UPDATERID,OPERATIONRID,UPDATETYPEINDICATOR,IESYSTEMCONTROLNUMBER,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.LNKCCRUPDATES;
        ...
        COMMIT;
        						...
        						UPDATE STATISTICS SISWEB_OWNER.LNKCCRUPDATES WITH FULLSCAN;
