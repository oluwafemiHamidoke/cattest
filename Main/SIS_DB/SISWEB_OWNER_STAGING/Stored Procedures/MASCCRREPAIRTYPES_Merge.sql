...
-- Modify Date: 
-- Description: Conditional load from STAGING MASCCRREPAIRTYPES
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.MASCCRREPAIRTYPES_Merge    
...
BEGIN
    ...
    BEGIN TRY
        ...
        IF @FORCE_LOAD = 'FALSE'
        BEGIN
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='MASCCRREPAIRTYPES', @SISWEB_OWNER_STAGING_TABLE = 'MASCCRREPAIRTYPES'
        END;
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.MASCCRREPAIRTYPES;
            
            INSERT INTO SISWEB_OWNER.MASCCRREPAIRTYPES (REPAIRTYPEINDICATOR,LANGUAGEINDICATOR,REPAIRTYPE,REPAIRTYPEDESCRIPTION,SEQUENCENUMBER,LASTMODIFIEDDATE)
            SELECT REPAIRTYPEINDICATOR,LANGUAGEINDICATOR,REPAIRTYPE,REPAIRTYPEDESCRIPTION,SEQUENCENUMBER,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.MASCCRREPAIRTYPES;
        ...
        COMMIT;
        						...
        						UPDATE STATISTICS SISWEB_OWNER.MASCCRREPAIRTYPES WITH FULLSCAN;
