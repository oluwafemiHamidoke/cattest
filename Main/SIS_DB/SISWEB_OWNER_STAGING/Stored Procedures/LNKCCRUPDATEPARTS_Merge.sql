...
-- Modify Date: 
-- Description: Merge SISWEB_OWNER_STAGING.LNKCCRUPDATEPARTS to SISWEB_OWNER.LNKCCRUPDATEPARTS
-- =============================================
CREATE PROCEDURE SISWEB_OWNER_STAGING.LNKCCRUPDATEPARTS_Merge
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            EXEC @MODIFIED_ROWS_PERCENTAGE = [SISWEB_OWNER_STAGING].[_getModifiedRowsPercentage] @SISWEB_OWNER_TABLE='LNKCCRUPDATEPARTS', @SISWEB_OWNER_STAGING_TABLE = 'LNKCCRUPDATEPARTS'
        ...
        BEGIN
            ...
            TRUNCATE TABLE SISWEB_OWNER.LNKCCRUPDATEPARTS;
            
            INSERT INTO SISWEB_OWNER.LNKCCRUPDATEPARTS (UPDATERID,LANGUAGEINDICATOR,PARTNUMBER,PARTNAME,QUANTITY,LASTMODIFIEDDATE)
            SELECT UPDATERID,LANGUAGEINDICATOR,PARTNUMBER,PARTNAME,QUANTITY,LASTMODIFIEDDATE
            from SISWEB_OWNER_STAGING.LNKCCRUPDATEPARTS;
        ...
        END;
        COMMIT;
        						UPDATE STATISTICS SISWEB_OWNER.LNKCCRUPDATEPARTS WITH FULLSCAN;
