CREATE TABLE [SISWEB_OWNER_STAGING].[LNKCCRTECHDOCSNP]
(
...
GO
ALTER TABLE [SISWEB_OWNER_STAGING].[LNKCCRTECHDOCSNP] ENABLE CHANGE_TRACKING WITH (TRACK_COLUMNS_UPDATED = ON);
GO
