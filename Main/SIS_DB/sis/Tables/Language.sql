CREATE TABLE [sis].[Language] (
    ...
    CONSTRAINT [PK_Language] PRIMARY KEY CLUSTERED ([Language_ID] ASC) WITH (FILLFACTOR = 100)
);
...
GO
CREATE NONCLUSTERED INDEX [IX_Language_Default]
    ON [sis].[Language]([Language_Code] ASC)
