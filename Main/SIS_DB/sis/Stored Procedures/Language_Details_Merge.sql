...
-- Description: Merge external table [sis_stage].[Language_Details] into [sis].[Language_Details]
-- Exec [sis].[Language_Details_Merge]
-- =============================================
CREATE PROCEDURE [sis].[Language_Details_Merge] ( @DEBUG BIT = 'FALSE' )
AS
BEGIN
    SET NOCOUNT ON
...
MERGE [sis].[Language_Details] AS tgt
    USING [sis_stage].[Language_Details] AS src
...
SET @LOGMESSAGE = IIF(@DEBUG = 'TRUE',(SELECT(SELECT COUNT(*) FROM @MERGE_RESULTS AS MR WHERE MR.ACTIONTYPE = 'INSERT') AS Inserted
													...
													,(SELECT MR.ACTIONTYPE
														...
														,WITHOUT_ARRAY_WRAPPER),'Language_Details Modified Rows');
...
Update STATISTICS sis.Language_Details with fullscan
