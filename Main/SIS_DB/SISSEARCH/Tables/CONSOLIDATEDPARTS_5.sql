CREATE TABLE [SISSEARCH].[CONSOLIDATEDPARTS_5] (
    ...
    CONSTRAINT [PK_CONSOLIDATEDPARTS_5] PRIMARY KEY CLUSTERED ([ID] ASC)
);
...
CREATE NONCLUSTERED INDEX [IX_CONSOLIDATEDPARTS_5_PARTNUMBER]
    ON [SISSEARCH].[CONSOLIDATEDPARTS_5]([Iesystemcontrolnumber] ASC) ;



GO

ALTER TABLE [SISSEARCH].[CONSOLIDATEDPARTS_5] ENABLE CHANGE_TRACKING WITH (TRACK_COLUMNS_UPDATED = OFF);
