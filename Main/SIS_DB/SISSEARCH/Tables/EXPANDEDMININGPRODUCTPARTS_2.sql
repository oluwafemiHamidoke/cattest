CREATE TABLE [SISSEARCH].[EXPANDEDMININGPRODUCTPARTS_2] (
    ...
    CONSTRAINT [PK_EXPANDEDMININGPRODUCTPARTS_2] PRIMARY KEY CLUSTERED ([ID] ASC)
    );
GO

CREATE NONCLUSTERED INDEX [IX_EXPANDEDMININGPRODUCTPARTS_2_PARTNUMBER_ORGCODE]
    ON [SISSEARCH].[EXPANDEDMININGPRODUCTPARTS_2]([IEpartNumber] ASC, [orgCode] ASC);
GO