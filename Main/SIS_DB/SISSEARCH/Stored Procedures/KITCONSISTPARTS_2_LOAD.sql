CREATE  Procedure [SISSEARCH].[KITCONSISTPARTS_2_LOAD] 
As
/*---------------
Date: 10-04-2017
Object Description:  Loading changed data into SISSEARCH.KITCONSISTPARTS_2 from base tables
Exec [SISSEARCH].[KITCONSISTPARTS_2_LOAD]
Truncate table [SISSEARCH].[KITCONSISTPARTS_2]
---------------*/
...
into #DeletedRecords
from  [SISSEARCH].[KITCONSISTPARTS_2]
Except 
Select IESYSTEMCONTROLNUMBER
...
SET @LAPSETIME = DATEDIFF(SS, @StepStartTime, GETDATE());
EXEC SISSEARCH.WriteLog @NAMEOFSPROC = @ProcName, @ISUPDATE = 1,@LAPSETIME = @LAPSETIME, @DATAVALUE = @RowCount, @LOGID = @StepLogID, 
@LOGMESSAGE =  'Deleted Records from Target [SISSEARCH].[KITCONSISTPARTS_2] ';
...
Select  @LASTINSERTDATE=coalesce(Max(INSERTDATE),'1900-01-01') From [SISSEARCH].[KITCONSISTPARTS_2]
...
Delete from [SISSEARCH].[KITCONSISTPARTS_2]
...
SET @LAPSETIME = DATEDIFF(SS, @StepStartTime, GETDATE());
EXEC SISSEARCH.WriteLog @NAMEOFSPROC = @ProcName, @ISUPDATE = 1,@LAPSETIME = @LAPSETIME, @DATAVALUE = @RowCount, @LOGID = @StepLogID, 
@LOGMESSAGE =  'Deleted Inserted Records from Target [SISSEARCH].[KITCONSISTPARTS_2]';
...
Insert into [SISSEARCH].[KITCONSISTPARTS_2] (IESYSTEMCONTROLNUMBER,ID,KITCONSISTPART,INSERTDATE)
...
SET @LAPSETIME = DATEDIFF(SS, @StepStartTime, GETDATE());
EXEC SISSEARCH.WriteLog @NAMEOFSPROC = @ProcName, @ISUPDATE = 1,@LAPSETIME = @LAPSETIME, @DATAVALUE = @RowCount, @LOGID = @StepLogID, 
@LOGMESSAGE =  'Insert into Target [SISSEARCH].[KITCONSISTPARTS_2]';
...
Insert into [SISSEARCH].[KITCONSISTPARTS_2] (IESYSTEMCONTROLNUMBER,ID,KITCONSISTPART,INSERTDATE)
Select IESYSTEMCONTROLNUMBER,ID,KITCONSISTPART,INSERTDATE from #RecordsToStringResult_C
