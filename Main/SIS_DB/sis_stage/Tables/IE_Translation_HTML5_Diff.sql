CREATE TABLE [sis_stage].[IE_Translation_HTML5_Diff] (
    ...
    CONSTRAINT [PK_IE_Translation_HTML5_Diff] PRIMARY KEY CLUSTERED ([IE_ID] ASC, [Language_ID] ASC) WITH (FILLFACTOR = 100)
);
