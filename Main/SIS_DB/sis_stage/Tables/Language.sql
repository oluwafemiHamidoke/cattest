CREATE TABLE [sis_stage].[Language] (
    ...
    CONSTRAINT [PK_Language] PRIMARY KEY CLUSTERED ([Language_Tag] ASC)
);
...
GO
CREATE NONCLUSTERED INDEX [IX_Legacy_Language_Indicator_E]
    ON [sis_stage].[Language]([Legacy_Language_Indicator] ASC, [Default_Language] ASC) WHERE ([Legacy_Language_Indicator]='E' AND [Default_Language]=(1));
