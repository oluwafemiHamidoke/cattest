...
-- Description: Merges a complex low performing query into [sis_stage].[CCRTechdocSNP_Effectivity] for SIS2 to access
-- =============================================

CREATE PROCEDURE [sis_stage].[CCRTechdocSNP_Effectivity_Load]
(@DEBUG      BIT = 'FALSE')
AS
BEGIN
    SET NOCOUNT ON
