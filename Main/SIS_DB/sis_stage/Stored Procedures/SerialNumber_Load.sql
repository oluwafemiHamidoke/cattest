...
-- Work Item  : 22348
-- =============================================
CREATE PROCEDURE sis_stage.SerialNumber_Load (@FORCE_LOAD BIT = 'FALSE'
											,@DEBUG      BIT = 'FALSE') 
AS
BEGIN
	...
	BEGIN TRY
		...
		WITH SerialNumber
			 ...
			 (
				 SELECT src.BUILDDATE, src.TESTDATE, src.SHIPPED
				 EXCEPT
				 SELECT tgt.Build_Date, tgt.TestDate, tgt.ShippedDate
			 )
				THEN UPDATE SET tgt.Build_Date = src.BUILDDATE, tgt.TestDate = src.TESTDATE, tgt.ShippedDate = src.SHIPPED
			 WHEN NOT MATCHED BY TARGET
				   THEN
				   INSERT(SerialNumber,Build_Date, TestDate, ShippedDate)
				   VALUES (src.SERIALNUMBER, src.BUILDDATE, src.TESTDATE, src.SHIPPED) 
